...
#define HostCmd_CMD_DBG_CFG                    0x2009
...
typedef PACK_START struct _HostCmd_DS_TX_FRAME_TEST {
	...
	u8 machdrLen;
	u16 payloadLen;
	u8 data[MAX_TX_FRAME_LEN];	// mac + payLoad
...
typedef PACK_START struct _HostCmd_FW_DBG_CFG {
	FWCmdHdr CmdHdr;
	u16 action;
	u16 dbgIdx;
	u32 num;
	U32 value[1];
} PACK_END HostCmd_FW_DBG_CFG, *PHostCmd_FW_DBG_CFG;
