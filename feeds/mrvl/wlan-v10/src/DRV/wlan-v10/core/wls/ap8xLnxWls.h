...
MEAS_TYPE_BASIC_REQ = 0,
		...
		MEAS_TYPE_LOC_IDENTIFIER_REQ,
		MEAS_TYPE_FTM_RANGE = 16,
		MEAS_TYPE_MEAS_PAUSE = 255} IEEEtypes_MeasurementType_e;
...
LOC_SUBJECT_LOCAL = 0,
		LOC_SUBJECT_REMOTE,
		LOC_SUBJECT_THIRD_PARTY} IEEEtypes_LocationSubject_e;
...
LCI_SUBELEM_LCI = 0,
		...
		LCI_SUBELEM_USAGE_RULES = 6,
		LCI_SUBELEM_COLOCATED_BSSID,
		LCI_SUBELEM_VENDOR_SPECIFIC =
		255} IEEEtypes_LCIReport_Subelements_e;
...
LOC_CIVIC_SUBELEM_LC = 0,
		...
		LOC_CIVIC_SUBELEM_MAP_IMAGE = 5,
		LOC_CIVIC_SUBELEM_VENDOR_SPECIFIC =
		255} IEEEtypes_LocCivicReport_Subelements_e;
...
RADIO_MEAS_REQ = 0,
		...
		LINK_MEAS_REPORT,
		NEIGHBOR_REPORT_REQ,
		NEIGHBOR_REPORT_RESP} IEEEtypes_Radio_Meas_Action_e;

//Table 8-114 - Optional subelement IDs for Fine Timing Measurement Range request
typedef enum __attribute__ ((__packed__)) {
FTMRANGE_SUBELEM_MAXAGE = 4,
		FTMRANGE_SUBELEM_VENDOR_SPECIFIC =
		221} IEEEtypes_FTMRange_Req_Subelem_e;
...
typedef enum __attribute__ ((__packed__)) {
FTMRANGE_REQ_INCAPABLE = 2,
		FTMRANGE_REQ_FAILED = 3,
		FTMRANGE_TX_FAILED = 8} IEEEtypes_FTMErrorEntry_ErrorCode_e;
...
typedef enum __attribute__ ((__packed__)) {
FTM_SESSION_NOT_STARTED = 0,
		FTM_SESSION_REQ_RCVD,
		FTM_SESSION_INIT_COMPLETE,
		FTM_SESSION_IN_BURST,
		FTM_SESSION_BURST_COMPLETE} ftm_session_state;
...
typedef struct WLS_FTM_CONFIG_st {
	...
	UINT8 ftm_RangeReportCapableDevices[MAX_NUM_RANGEREPORT_DEV]
