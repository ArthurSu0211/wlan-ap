...
#define DRV_VERSION_SUFFIX  "24.4.2064.00"
#else
...
#define DRV_VERSION   DRV_VERSION_SUFFIX ENDIAN_SUFFIX SOC_SUFFIX OS_SUFFIX PLATFORM_SUFFIX FEATURE_SUFFIX EEPROM_PWR_SUFFIX
