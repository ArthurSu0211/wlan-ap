...
static int nl80211_mgmt_subscribe_auth(struct i802_bss *bss)
{
	int ret = 0;
...
#if defined(CONFIG_MRVL_OWE) || defined(CONFIG_MBO)
static int nl80211_mgmt_subscribe_re_assoc(struct i802_bss *bss)
{
	int ret = 0;
...
#endif /* CONFIG_MRVL_OWE || CONFIG_MBO */
...
static int nl80211_mgmt_subscribe_ap_dev_sme(struct i802_bss *bss)
{
	...
	if (nl80211_mgmt_subscribe_auth(bss))
		goto out_err;

#if defined(CONFIG_MRVL_OWE) || defined(CONFIG_MBO)
	if(nl80211_mgmt_subscribe_re_assoc(bss))
		goto out_err;
#endif
				   ...
				   const char *driver_params)
{
	...
	//TODO marvell driver don't need this
#if 0
	if (set_addr &&
				     ...
				     struct wpa_driver_ap_params *params)
{
	...
	marvell_configure_wpa(priv, params, beacon_set);
#endif
		       ...
		       struct wpa_init_params *params)
{
	...
	//TODO marvell driver don't need these
#if 0
...
const struct wpa_driver_ops wpa_driver_nl80211_ops = {
	...
	.add_sta_node = marvell_add_sta_node,
	...
	.send_mgmt = marvell_send_mgmt,
	.updown_vap = marvell_updown_vap,
	.do_acs = marvell_do_acs,
	.set_rrm = marvell_set_rrm,
